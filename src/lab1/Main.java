...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Aici chemam metoda pentru exercitiul 1 sa se execute
        exercitiu_1();

        //  Aici chemam metoda pentru exercitiul 2 sa se execute
        exercitiul_2();

        // Aici chemam metoda pentru exercitiul 4 sa se execute
        exercitiul_4();
    };

    public static void exercitiu_1() {
